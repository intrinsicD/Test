...
## Follow-Up Work
- Implement the acceptance criteria in [`docs/archive/backlog/legacy/tasks/T_0112_GEOMETRY_IO_ROUNDTRIP_HARDENING.md`](../archive/backlog/legacy/tasks/T_0112_GEOMETRY_IO_ROUNDTRIP_HARDENING.md).
