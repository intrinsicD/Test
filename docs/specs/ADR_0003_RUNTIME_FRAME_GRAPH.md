...
## Follow-Up Work
- Document runtime integration steps in [`docs/archive/backlog/legacy/tasks/T_0104_RUNTIME_FRAME_GRAPH_INTEGRATION.md`](../archive/backlog/legacy/tasks/T_0104_RUNTIME_FRAME_GRAPH_INTEGRATION.md).
