...
**Related ADR**: [`ADR-0007-ai-004-configuration-schema`](../specs/ADR_0007_AI_004_CONFIGURATION_SCHEMA.md)
...
[`AI-004 Prototyping Playbook`](AI_004_PROTOTYPING_PLAYBOOK.md); keep both records synchronized when fields evolve.
