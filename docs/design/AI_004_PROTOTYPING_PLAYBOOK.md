...
The schema lives in
[`docs/design/AI_004_CONFIGURATION_SCHEMA.md`](AI_004_CONFIGURATION_SCHEMA.md)
...
- Baseline dataset metrics, rendering defaults, and telemetry targets for both
  scenarios are recorded in [`docs/design/RT_321_CASE_STUDIES.md`](RT_321_CASE_STUDIES.md).
