...
- Benchmark harness sources and build target integrated into CMake (`engine_animation_benchmark_driver`) emitting dispatcher-compatible telemetry (see [`AN-230.2 GPU Sampling Telemetry Integration`](AN_230_2_GPU_TELEMETRY.md)).
