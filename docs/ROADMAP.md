...
| 2 | [`TL-313`](../hybrid_workflow/backlog/TL-313-asset-browser-panel.md) | Expose asset cache state and hot reload telemetry within the editor. | Tools Lead | Ready |
...
| [`TL-313`](../hybrid_workflow/backlog/TL-313-asset-browser-panel.md) | 2 | Ready | Asset cache inspector with hot reload telemetry surfaced in-editor; registry/asset API grooming complete. |
