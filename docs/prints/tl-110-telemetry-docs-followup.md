...
- [ ] Document troubleshooting flows (log capture, missing shared library hints) to complete the remaining `TL-110` acceptance criteria (owner: Tools docs, priority: medium).
