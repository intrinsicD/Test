...
| ADR / Spec | [ADR-0008](../../../specs/ADR-0008-runtime-main-loop-and-tooling.md) | Requires scripting hooks via C API and presentation instrumentation alignment.【F:docs/specs/ADR-0008-runtime-main-loop-and-tooling.md†L33-L129】 | 6 |
...
| 4 | [RT-410 backlog](../../../backlog/active/RT-410-runtime-stage-planner.md) | DoD checklist demands synchronisation hooks with documentation; C API bridge addresses scripting facet.【F:docs/backlog/active/RT-410-runtime-stage-planner.md†L31-L37】 | Knowledge Librarian | Append backlog note after merge. |
...
| 6 | [ADR-0008](../../../specs/ADR-0008-runtime-main-loop-and-tooling.md) | Confirms requirement for scripting hooks across C/Python surfaces; no ADR change required.【F:docs/specs/ADR-0008-runtime-main-loop-and-tooling.md†L33-L129】 | Knowledge Librarian | Ensure implementation references ADR where appropriate. |
