...
- 2025-12-24: Implemented capsule–cylinder intersection queries with symmetric overloads and regression tests covering lateral and cap contact cases so character proxies interact with cylindrical obstacles deterministically.
- 2025-12-26: Implemented capsule–ellipsoid intersection queries backed by a shared GJK solver with deterministic sampling fallback and added regression tests covering intersecting, grazing, and separated scenarios for both overload orders.
