...
## Streams
- **Frame-Graph Metadata:** Extend resource descriptors, queue affinity, and validation hooks per [`docs/specs/ADR_0003_RUNTIME_FRAME_GRAPH.md`](../../../../specs/ADR_0003_RUNTIME_FRAME_GRAPH.md).
...
## Notes
- <a id="ai-004-kickoff-readiness"></a>
- 2025-11-22: Kickoff readiness checklist now lives in [`AI-004-kickoff-brief.md`](../../../../../hybrid_workflow/backlog/AI-004-kickoff-brief.md); ensure roadmap, initiative card, and risk register stay in sync before the 2025-12-05 review.
- Coordinate with `docs/modules/rendering/BACKLOG.md` for milestone sequencing.
...
- 2025-02-18: Sprint goal was previously blocked by the stubbed Googletest
  dependency; [`T-0118`](T_0118_TESTING_FRAMEWORK_UPGRADE.md) resolved the
  fixture gap so end-to-end validation can resume.
- 2025-02-20: `engine/tests/integration/test_runtime_integration.cpp` now
  includes a deterministic `RuntimeHost::submit_render_graph` regression,
  satisfying `RT-003.3` by asserting Vulkan submissions remain stable across
