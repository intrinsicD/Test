...
Cylinder– and capsule–ellipsoid testing now rely on a GJK-driven solver with deterministic fallbacks so thin, rotated ellipsoids cannot slip through visibility filters while character capsules continue to register grazing contacts.
