...
exposes dataset, rendering, and benchmarking controls in a single window.

Key capabilities:

- **Dataset browser** – searchable list of datasets with statistics, metric
  snapshots, and source/output asset references.
