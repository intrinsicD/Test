...
- Emits diagnostics and telemetry for lifecycle monitoring.
...
| --- | --- | --- | --- |
| `RU-307` | Reconcile submission hooks with Vulkan backend (`RT-003`). | Unified submission struct validated by integration tests. | 🔄 In Progress |
