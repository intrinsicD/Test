...
## Definition of Done
- [ ] Completed backlog entries (DC-040, DC-041, RT-320, TL-210, RT-321, AS-330, CC-310, CC-311, PL-240) are moved to `docs/backlog/archive/` with preserved metadata.【F:docs/backlog/active/DC-040-ai-004-configuration-schema.md†L1-L42】【F:docs/backlog/archive/README.md†L1-L64】
- [ ] `docs/ROADMAP.md` active snapshot and tables reference only open work and document the archival outcome for PL-240.【F:docs/ROADMAP.md†L96-L118】
- [ ] `docs/NAVIGATION.md` and any module README links referencing moved backlog items are updated accordingly.【F:docs/NAVIGATION.md†L96-L107】
- [ ] `python scripts/validate_docs.py` and roadmap/backlog linting succeed after the updates.【F:README.md†L122-L142】
