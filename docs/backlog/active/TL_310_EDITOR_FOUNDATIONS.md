...
## Dependencies
- [`ADR-0008`](../../specs/ADR_0008_RUNTIME_MAIN_LOOP_AND_TOOLING.md) — shared panel registry and loop integration guidance.
- [`RT-410`](RT_410_RUNTIME_STAGE_PLANNER.md) — supplies synchronisation hooks.
