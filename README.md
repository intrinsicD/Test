...
| Core | ✅ Stable | EnTT-backed registry façade, subsystem discovery helpers, module bootstrap plumbing, and dependency cycle diagnostics protecting `DC-001`. | Follow-up: `CR-137` surface initialization failure logs/metrics inside diagnostics viewer tooling and runtime runbook. |
