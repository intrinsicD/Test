...
| Geometry | ✅ Stable | `SurfaceMesh` utilities, halfedge conversions, procedural primitives, ASCII IO, kd-tree/octree accelerators, and CPU linear blend skinning deformers. | `GE-212`: draft remeshing/parameterisation RFP and prepare `GE-220` telemetry alignment. |
