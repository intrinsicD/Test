...
| Geometry | ✅ Stable | `SurfaceMesh` utilities, halfedge conversions, procedural primitives, ASCII IO, kd-tree/octree accelerators, and CPU linear blend skinning deformers. | `GE-220`: instrument geometry telemetry once remeshing/parameterisation RFP (`GE-212`) outcomes are staffed. |
