...
| Compute | With configurable timing clocks in place, focus on the thread-pool executor and parallel dispatch telemetry tracked under `AI-004` so reports cover multi-domain timings ahead of the CUDA executor expansion. | [docs/modules/compute/README.md](docs/modules/compute/README.md)<br>[docs/modules/compute/ROADMAP.md](docs/modules/compute/ROADMAP.md) |
...
| Physics | Extend the new sequential impulse solver with friction and visualisation hooks while broadening telemetry and editor-facing diagnostics. | [docs/modules/physics/README.md](docs/modules/physics/README.md)<br>[docs/modules/physics/ROADMAP.md](docs/modules/physics/ROADMAP.md) |
...
| Scene | Apply the new hierarchy validation reports while defining schemas for core runtime components, broadening traversal helpers, and versioning the serialization format alongside expanded tests. | [docs/modules/scene/README.md](docs/modules/scene/README.md)<br>[docs/modules/scene/ROADMAP.md](docs/modules/scene/ROADMAP.md) |
