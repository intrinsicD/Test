...
| Core | ✅ Stable | EnTT-backed registry façade, subsystem discovery helpers, module bootstrap plumbing, and dependency cycle diagnostics protecting `DC-001`. | Follow-up: structured logging for subsystem initialization failures informed by CR-135 telemetry guidance. |
