...
| Math | ✅ Stable | Vector/matrix/quaternion primitives, orthonormal basis helpers, and transform utilities feeding animation, geometry, and physics. | External-format conversion cheatsheet published in `docs/modules/math/format_conversions.md`; `MA-130` scopes conversion telemetry metrics. |
