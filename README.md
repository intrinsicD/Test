...
| Integrate local and virtual filesystem providers for asset loading. | [engine/platform/filesystem/README.md](engine/platform/include/engine/platform/filesystem/README.md) |
