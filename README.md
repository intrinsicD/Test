...
| Deliver the pre-1.0 integration readiness milestones tracked per module owners. | [engine/README.md](engine/README.md) |
| Execute the geometry shapes stabilisation plan (Obb decisions, documentation, benchmarks, tutorials). | [engine/geometry/include/engine/geometry/shapes/README.md](engine/geometry/include/engine/geometry/shapes/README.md) |
