...
| Geometry & IO | Finish wiring graph/mesh/point-cloud pipelines, enrich import/export diagnostics, and extend spatial/algorithmic tooling before remeshing work begins. | [engine/geometry/README.md](engine/geometry/README.md)<br>[engine/io/README.md](engine/io/README.md) |
