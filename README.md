...
| `CC-002` | Hot reload infrastructure. | Connect filesystem watchers to cache callbacks with failure telemetry. | Assets, Platform | 🟢 Ready to Start |

### Sprint Horizon

| Horizon | Rank | Initiative | Primary Deliverable |
| --- | --- | --- | --- |
| Sprint 1 | 1 | `AI-003` | `RE-503` metadata schema validated against Vulkan backend needs. |
