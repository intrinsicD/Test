...
## 2. Scope & Boundaries
- In scope:
  - Review roadmap priority tables and active backlog files for status drift or archival candidates.【F:docs/ROADMAP.md†L19-L118】【F:docs/backlog/archive/DC-040-ai-004-configuration-schema.md†L1-L42】【F:docs/backlog/archive/PL-240-platform-filesystem-watcher-guidance.md†L1-L27】
...
- Documentation: Recommend roadmap/backlog updates, including archival moves for fully complete items still listed as active and roadmap coverage gaps (e.g., PL-240).【F:docs/ROADMAP.md†L96-L118】【F:docs/backlog/archive/PL-240-platform-filesystem-watcher-guidance.md†L1-L27】
