...
| 4 | [`hybrid_workflow/backlog/archive/TL-313-asset-browser-panel.md`](../../hybrid_workflow/backlog/archive/TL-313-asset-browser-panel.md) | Acceptance criteria emphasise cache metadata, filtering, docs/tests alignment, and Steps log updates. | Mark steps + status transitions during implementation. |
