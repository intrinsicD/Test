...
- **Backlog Entry:** [`docs/backlog/active/T-0119-command-encoder-integration.md`](../../docs/backlog/active/T-0119-command-encoder-integration.md)
...
| --- | --- | --- | --- |
| Module README | [`docs/modules/rendering/README.md`](../../docs/modules/rendering/README.md) | Flags missing GPU resource/command encoder work as blocker. | 5 |
| ADR / Spec | [`docs/specs/ADR-0003-runtime-frame-graph.md`](../../docs/specs/ADR-0003-runtime-frame-graph.md); [`docs/specs/ADR-0008-runtime-main-loop-and-tooling.md`](../../docs/specs/ADR-0008-runtime-main-loop-and-tooling.md) | Define frame-graph submission contract and presentation separation constraints. | 6 |
...
| Telemetry / Benchmarks | [`docs/backlog/active/PM-510-weekly-integration-demos.md`](../../docs/backlog/active/PM-510-weekly-integration-demos.md) | Weekly demos will surface GPU telemetry once backend executes. | 4 |
...
| 2 | [`docs/NAVIGATION.md`](../../docs/NAVIGATION.md) | Establishes precedence chain requiring backlog/ADR citations in docs updates. | Knowledge Librarian | Coordinate README update to reflect new encoder work. |
| 3 | [`docs/ROADMAP.md`](../../docs/ROADMAP.md) | Phase 4 priority 1 emphasises completing T-0119 alongside GPU provider work. | Product Manager | Update roadmap notes once Vulkan encoder lands. |
| 4 | [`docs/backlog/active/T-0119-command-encoder-integration.md`](../../docs/backlog/active/T-0119-command-encoder-integration.md) | DoD explicitly calls for wiring encoder submission paths into Vulkan scheduler. | Specialist Engineer | Mark checklist item complete after implementation. |
| 5 | [`docs/modules/rendering/README.md`](../../docs/modules/rendering/README.md) | Highlights missing command encoder as outstanding work; README must mention progress. | Specialist Engineer | Update README upon delivery. |
| 6 | [`docs/specs/ADR-0003-runtime-frame-graph.md`](../../docs/specs/ADR-0003-runtime-frame-graph.md); [`docs/specs/ADR-0008-runtime-main-loop-and-tooling.md`](../../docs/specs/ADR-0008-runtime-main-loop-and-tooling.md) | Provide architectural guardrails for frame-graph submission and runtime presentation integration. | Chief Architect | Verify changes stay compliant; escalate deviations. |
