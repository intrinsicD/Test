...
namespace engine::animation
{
    namespace
    {
        ...
        [[nodiscard]] const BlendTreeParameter* parameter_at(const AnimationBlendTree& tree,
    ...
    void sort_keyframes(JointTrack& track)
    {
        ...
        auto last_unique = std::unique(track.keyframes.begin(), track.keyframes.end(),
    ...
    AnimationClip make_default_clip()
    {
        ...
        root_track.keyframes = {
            Keyframe{
                0.0,
                JointPose{
                    math::vec3{0.0F, 0.0F, 0.0F}, math::quat{1.0F, 0.0F, 0.0F, 0.0F}, math::vec3{1.0F, 1.0F, 1.0F}
                }
            },
            Keyframe{
                0.5,
                JointPose{
                    math::vec3{0.0F, 0.5F, 0.0F}, math::quat{1.0F, 0.0F, 0.0F, 0.0F}, math::vec3{1.0F, 1.0F, 1.0F}
                }
            },
            Keyframe{
                1.0,
    ...
    bool set_float_parameter(AnimationBlendTree& tree, std::size_t parameter, float value) noexcept
    {
        ...
        if (auto* entry = parameter_at(tree, parameter); entry != nullptr && entry->type ==
            BlendTreeParameterType::kFloat)
        {
