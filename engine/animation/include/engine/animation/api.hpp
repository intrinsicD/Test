...
namespace engine::animation
{
    ...
    ENGINE_ANIMATION_API void
    set_linear_blend_weight(AnimationBlendTree& tree, std::size_t node, float weight) noexcept;
    ENGINE_ANIMATION_API void set_additive_blend_weight(AnimationBlendTree& tree, std::size_t node,
