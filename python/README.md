...
- Ships manually curated `.pyi` stubs for `engine3g.loader` and
  `engine3g.config_schema` so editors and static analyzers have type
  information while `PY-001` bindings mature (see
